...
Use water data from the batch process.
...
INPUT_FILE_NAME = "water_data.csv"
...
def prepare_message_from_row(row):
    ...
    site_id, read_date, salinity, Dissolved_Oxygen, pH = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{site_id}, {read_date}, {salinity}, {Dissolved_Oxygen}, {pH}]"
